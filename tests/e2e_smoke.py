...
def run_profile(browser,base,mobile=False):
    ...
    assert '24.58.0' in page.locator('#diagnostics-status').inner_text()
    ...
    assert backup['format']=='tadaruq-backup' and backup['appVersion']=='24.58.0' and backup['dataVersion']==3
