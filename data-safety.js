...
(function(){
  ...
  const EXACT_KEYS=[
    ...
    'dua-fav','my-duas','rs-fav','qalb-track','qalb-journal','qalb-prog','qalb-paths-v1',
  ...
  const EXPECTED={
    ...
    'qalb-journal':'object','qalb-prog':'object','qalb-paths-v1':'array','khabia':'object','irt-hist':'array',
  ...
  async function createPortableBackup(){
    ...
    const core={
      format:BACKUP_FORMAT,backupVersion:BACKUP_VERSION,appVersion:'24.3.0',
