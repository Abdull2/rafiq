...
(function(){
  ...
  const EXACT_KEYS=[
    'settings','qada','profile-v1','onboarding-seen-v3','saved-later-v1','todo-items','quran-pos','quran-khatmas-v1','tafsir-pos-v1',
  ...
  const EXPECTED={
    ...
    'quran-pos':'object','quran-khatmas-v1':'object','tafsir-pos-v1':'object','dua-fav':'array','my-duas':'array','rs-fav':'array','qalb-track':'object',
  ...
  async function createPortableBackup(){
    ...
    const core={
      format:BACKUP_FORMAT,backupVersion:BACKUP_VERSION,appVersion:globalThis.TADARUQ_META?.appVersion||'24.58.1',
